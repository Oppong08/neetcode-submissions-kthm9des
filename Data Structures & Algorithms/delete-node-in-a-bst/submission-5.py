...
class Solution:
    def deleteNode(self, root: Optional[TreeNode], key: int) -> Optional[TreeNode]:
        ...
        if key < root.val:
            #search and delete left
            root.left = self.deleteNode(root.left, key)

        elif key > root.val:
            #searcn and delete right
            ...
            if not root.left:
                ...
                #repalce current node's value with successor
                root.val = cur.val
        ...
        # # return root
        # #we could also find the inorder predecessor (largest value on the left subtree)
        #     cur = root.left
        #     while cur.right:
        #         cur = cur.right
